Contributing to Humanus Core
============================

The Humanus Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Humanus Core project, and is not to be
confused with overall Humanus Network Protocol consensus changes.

Whether a pull request is merged into Humanus Core rests with the project merge
...
Patches that change Humanus consensus rules are considerably more involved than
...
Where a patch set proposes to change the Humanus consensus, it must have been
...
The project leader is the release manager for each Humanus Core release.
