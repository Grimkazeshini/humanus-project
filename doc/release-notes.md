Humanus Core version *3.1.1* is now available from:  <https://github.com/humanus-project/humanus/releases>
...
Please report bugs using the issue tracker at github: <https://github.com/humanus-project/humanus/issues>

Non-Mandatory Update
==============

Humanus Core v3.1.1 is a non-mandatory update to address bugs and introduce minor enhancements that do not require a network change.

How to Upgrade
==============

If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/Humanus-Qt (on Mac) or humanusd/humanus-qt (on Linux).


Compatibility
==============

Humanus Core is extensively tested on multiple operating systems using
...
Humanus Core should also work on most other Unix-like systems but is not
...
zHMS stake set to update more frequently and lowering the stake hashdrift to 30 seconds to reduce the number of orphans being experienced by Humanus stakers.
...
### Show progress percent for zhms reindex operations
...
Humanus Daemon & Client (RPC Changes)
--------------
...
### GUI
 ...
 - #612 `6dd752cb5` [Qt] Show progress percent for zhms reindex operations (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/humanus-project-translations/).
