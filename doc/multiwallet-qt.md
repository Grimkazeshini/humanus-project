...
In order to support loading of multiple wallets in humanus-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is humanus.cpp.
...
Changes to humanus.cpp
----------------------
humanus.cpp is the entry point into humanus-qt, and as such, will require some minor modifications to provide hooks for
