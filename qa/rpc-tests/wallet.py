...
#   c) node1 mines 32 blocks, so now node 0 has 60001hms, node 1 has 4250hms, node2 has none.
#   d) node0 sends 601 hms to node2, in two transactions (301 hms, then 300 hms).
