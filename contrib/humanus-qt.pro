...
RESOURCES += src/qt/humanus.qrc src/qt/humanus_locale.qrc

TRANSLATIONS += src/qt/locale/humanus_bg.ts \
                src/qt/locale/humanus_de.ts \
                src/qt/locale/humanus_en.ts \
                src/qt/locale/humanus_es.ts \
                src/qt/locale/humanus_fi.ts \
                src/qt/locale/humanus_fr.ts \
                src/qt/locale/humanus_it.ts \
                src/qt/locale/humanus_ja.ts \
                src/qt/locale/humanus_pl.ts \
                src/qt/locale/humanus_pt.ts \
                src/qt/locale/humanus_ru.ts \
                src/qt/locale/humanus_sk.ts \
                src/qt/locale/humanus_sv.ts \
                src/qt/locale/humanus_vi.ts \
                src/qt/locale/humanus_zh_CN.ts \
                src/qt/locale/humanus_zh_TW.ts
