...
/** Utility functions used by the Humanus Qt UI.
 */
namespace GUIUtil
{
...
// Render Humanus addresses in monospace font
...
// Parse "humanus:" URI into recipient object, return true on successful parsing
