...
/* Humanus GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Humanus"
#define QAPP_ORG_DOMAIN "humanus.org"
#define QAPP_APP_NAME_DEFAULT "Humanus-Qt"
#define QAPP_APP_NAME_TESTNET "Humanus-Qt-testnet"
