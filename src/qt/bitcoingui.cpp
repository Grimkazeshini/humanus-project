                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Humanus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Humanus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and humanus: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHMS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Humanus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Humanus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Humanus"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Humanus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Humanus addresses"));
    ...
    openAction->setStatusTip(tr("Open a Humanus: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Humanus Core help message to get a list with possible Humanus command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Humanus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Humanus network", "", count));
}
...
{
    QString strTitle = tr("Humanus Core"); // default title
