                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzHMSPathCustom = GetArg("-zhmsbackuppath", "");
    ...
    if(!strzHMSPathCustom.empty()) {
        ui->wallet_customzhmsbackuppath->setText(QString::fromStdString(strzHMSPathCustom));
        ui->wallet_customzhmsbackuppath_label->setVisible(true);
        ui->wallet_customzhmsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzHMSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Humanus RPC console.") + "<br>" +
