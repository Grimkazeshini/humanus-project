...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Humanus Core humanus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  humanus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded humanus transaction") + "\n" +
                               "  humanus-tx [options] -create [commands]   " + _("Create hex-encoded humanus transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded humanus transaction
