...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Humanus server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Humanus features */
        {"humanus", "masternode", &masternode, true, true, false},
        {"humanus", "listmasternodes", &listmasternodes, true, true, false},
        {"humanus", "getmasternodecount", &getmasternodecount, true, true, false},
        {"humanus", "masternodeconnect", &masternodeconnect, true, true, false},
        {"humanus", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"humanus", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"humanus", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"humanus", "masternodecurrent", &masternodecurrent, true, true, false},
        {"humanus", "masternodedebug", &masternodedebug, true, true, false},
        {"humanus", "startmasternode", &startmasternode, true, true, false},
        {"humanus", "createmasternodekey", &createmasternodekey, true, true, false},
        {"humanus", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"humanus", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"humanus", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"humanus", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"humanus", "getmasternodescores", &getmasternodescores, true, true, false},
        {"humanus", "mnbudget", &mnbudget, true, true, false},
        {"humanus", "preparebudget", &preparebudget, true, true, false},
        {"humanus", "submitbudget", &submitbudget, true, true, false},
        {"humanus", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"humanus", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"humanus", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"humanus", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"humanus", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"humanus", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"humanus", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"humanus", "checkbudgets", &checkbudgets, true, true, false},
        {"humanus", "mnsync", &mnsync, true, true, false},
        {"humanus", "spork", &spork, true, true, false},
        {"humanus", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzhmsseed", &getzhmsseed, false, false, true},
        {"zerocoin", "setzhmsseed", &setzhmsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzhms", &searchdzhms, false, false, true},
        {"zerocoin", "dzhmsstate", &dzhmsstate, false, false, true}
...
{
    return "> humanus-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6563/\n";
}
