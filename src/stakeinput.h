...
#ifndef Humanus_STAKEINPUT_H
#define Humanus_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZHMS() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zHMSStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zhms, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZHMS() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZHMS() override { return false; }
};


#endif //Humanus_STAKEINPUT_H
