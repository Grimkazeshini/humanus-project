...
/**
 * Humanus RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzhmsseed(const UniValue& params, bool fHelp);
extern UniValue getzhmsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzhms(const UniValue& params, bool fHelp);
extern UniValue dzhmsstate(const UniValue& params, bool fHelp);
